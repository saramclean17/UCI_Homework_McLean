...
#save references to new table
Measurement = Base.classes.measurement
Station = Base.classes.station

#create session linking Python to new database
...
##################################################
##Flask API Set Up Home Page Query all Available Routes
@app.route("/")
def home():
